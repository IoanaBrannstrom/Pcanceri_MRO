...
#modified by Ioana to remove red (#ff0000) 
#It works on Noisy, hopefully on Uppmax too because it needs BioPerl

##USAGE: perl FigTree2seq_remove_red.pl nexus_file original_fasta_file
##This script removes the blue sequences coloured in FigTree from a fasta file
##Last modified Aug 18, 2014. 
## Fabien Burki
##Last modified March 06, 2019 by Ioana. 
