...
#This script will color the taxa in the trees based on a certain name tag. See bellow 
#Argument : the name of the tree file (nexus format)
# author: Elena Coulier.
...
while(<F>){
    ...
    if ($taxa and (/\t.*_.*/)){
		...
		#Rhizaria_out
        $_ = add_color("Endomyxa",$colorRhizaria_out,$_);
        $_ = add_color("Foraminifera",$colorRhizaria_out,$_);
        $_ = add_color("Cercozoa",$colorRhizaria_out,$_);
        $_ = add_color("Thaumatomonadida",$colorRhizaria_out,$_);
        $_ = add_color("Polycystinea",$colorRhizaria_out,$_);
		$_ = add_color("Imbricatea",$colorRhizaria_out,$_);
        
        
        
        #Stramenopiles
        $_ = add_color("Stramenopiles",$colorStramenopiles,$_);
        $_ = add_color("Oomycota",$colorStramenopiles,$_);
        $_ = add_color("Blastocystis",$colorStramenopiles,$_);
        $_ = add_color("Blastocystidae",$colorStramenopiles,$_);
        $_ = add_color("Bacillariophyceae",$colorStramenopiles,$_);
        $_ = add_color("Pelagophyceae",$colorStramenopiles,$_);
        $_ = add_color("Phaeophyceae",$colorStramenopiles,$_);
        $_ = add_color("Eustigmatophyceae",$colorStramenopiles,$_);
        $_ = add_color("Thalassiosira",$colorStramenopiles,$_);
        $_ = add_color("Hondaea",$colorStramenopiles,$_);
        $_ = add_color("Xanthophyceae",$colorStramenopiles,$_);
        $_ = add_color("Bigyra",$colorStramenopiles,$_);
        $_ = add_color("Bacillariophyta",$colorStramenopiles,$_);
        $_ = add_color("Chrysoparadoxa",$colorStramenopiles,$_);
        $_ = add_color("Chrysophyceae",$colorStramenopiles,$_);
        $_ = add_color("Synurophyceae",$colorStramenopiles,$_);
        $_ = add_color("Raphidophyceae",$colorStramenopiles,$_);
